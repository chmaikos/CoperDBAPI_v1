...
source_grid = 'data/ERA5_Wind3H.nc'
target_grid = 'data/CMEMS_Wave3H.nc'

# Bilinear interpolation
cdo.remapbil(target_grid, input=source_grid, output="data/ERA5_Wind3H_remapBL.nc")
...
source = 'data/CMEMS_Wave3H.nc'
target = 'data/gridspec.txt'

# 1st order Conservative interpolation
cdo.remapcon(target, input=source, output='data/CMEMS_WaveDir_remapCON.nc')

waveDirData = Dataset('data/CMEMS_WaveDir_remapCON.nc', 'r+')
...
# ==========================================================================
filename = os.path.join(output_dir, 'data/CMEMS_WaveDir_remapCON.csv')
